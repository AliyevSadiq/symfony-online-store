...
class ProductManager extends AbstractBaseManager
{
    ...
    public function updateProductImages(Product $product, ?string $tempFilename = null): Product
    {
        if (!$tempFilename) {
            return $product;
        }
        ...
        $productImage = $this->productImageManager->saveImageForProduct($productDir, $tempFilename);
