...
class CategoryController extends AbstractController
{
    ...
    public function list(CategoryRepository $categoryRepository): Response
    {
        ...
        return $this->render('admin/category/list.html.twig',compact('categories'));
    }

    #[Route('/edit/{category}', name: 'edit', requirements: ['category' => '\d+'], methods: ['GET', 'POST'])]
    #[Route('/add', name: 'add', methods: ['GET', 'POST'])]
    public function save(Request $request,CategoryFormHandler $categoryFormHandler, ?Category $category): Response
    {
       $editCategoryModel=EditCategoryModel::makeFromCategory($category);
        ...
        if ($form->isSubmitted() && $form->isValid()){
           $category= $categoryFormHandler->editProcessForm($editCategoryModel);
    ...
    #[Route('/delete/{category}', name: 'delete', requirements: ['category' => '\d+'])]
    public function delete(Category $category,CategoryManager $categoryManager): Response
    {
        $categoryManager->remove($category);

        $this->addFlash('warning','Category were saved');
